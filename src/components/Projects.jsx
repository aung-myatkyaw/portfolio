...
const projects = [
  {
    ...
    description:
      'Architecting secure multicloud infrastructure for scalable AI applications. Automated CI/CD pipelines with embedded security scanning, deployed containerized AI workloads on Kubernetes, and drove adoption of security-first practices across the engineering org.',
    stages: ['Plan', 'Build', 'Scan', 'Deploy', 'Monitor'],
    technologies: [
      { name: 'AWS', tag: 'cloud' },
      { name: 'Kubernetes', tag: 'cloud' },
      { name: 'GitHub Actions', tag: 'cicd' },
      { name: 'Terraform', tag: 'cloud' },
      { name: 'AI Infrastructure', tag: 'ai' },
      { name: 'Prometheus', tag: 'cicd' },
      { name: 'Grafana', tag: 'cicd' },
    ],
