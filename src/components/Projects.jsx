...
const projects = [
  {
    ...
    description:
      'Sole platform engineer delivering diverse product stacks via CI/CD — 50+ Terraform projects, multiple EKS clusters, LiteLLM gateway, Istio, observability, and Frappe ERPNext/HRMS on Kubernetes. Infrastructure and release pipelines first; not primary application development.',
  ...
  },
  {
    ...
    description:
      "GitLab CI/CD for microservices at one of Myanmar's largest banks — delivered Java and Angular projects to production across multiple teams via pipelines and release automation.",
  ...
  },
  {
    ...
    description:
      'DevOps delivery for a logistics startup — CI/CD and releases for Vue.js and Node.js apps, VM/database provisioning, and integration testing.',
    stages: ['Release', 'Provision', 'Deploy', 'SIT', 'Ship'],
    technologies: [
      { name: 'Vue.js', tag: 'cicd' },
      { name: 'Node.js', tag: 'cicd' },
      { name: 'CI/CD', tag: 'cicd' },
  ...
  },
  {
    ...
    description:
      'Began in C#/Angular application development, then shifted to DevOps — since then focused on CI/CD delivery and infrastructure rather than feature development.',
